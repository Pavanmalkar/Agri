...
<body>
  ...
  <div class="container">
    ...
    <div class="item" onclick="location.href='product.jsp?name=Product%204&price=299.00&image=img/insects/i4.avif'">
  ...
  <div class="container">
    ...
    <div class="item" onclick="location.href='product.jsp?name=Product%206&price=799.00&image=img/insects/i1.avif'">
      <img src="img/insects/i1.avif" alt="Product 6">
